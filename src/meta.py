...
meta_replacements["arkanoid"] = (GameMeta()
                                 .with_title("Arkanoid")
                                 ...
                                 .add_tag("Arcade")
                                 .add_tag("Bloques")
                                 .with_authors(["Cesar Rodriguez", "Rovel Perez"]))
...
meta_replacements["duck-hunt"] = (GameMeta()
...
meta_replacements["breakout"] = (GameMeta()
                                 .with_title("Breakout")
                                 ...
                                 .add_tag("Arcade")
                                 .add_tag("Clásico")
                                 .add_author("Isaac Salazar")
                                 .add_author("Pedro Morese"))
